...
module.exports = class Config {
	constructor(self, argv, settings, tasks) {
		...
		throw new TypeError('Could not configure your webpack with this settings. Please, define the tasks.');
	}
	...
	static fn(self, argv, settings, tasks) {
		...
		let cmd = new Command(self, argv, settings, tasks);
		if (is.undefined(argv)) {
